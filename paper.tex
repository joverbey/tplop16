...
Mutable ASTs are conceptually simple and allow code for specific refactorings
...
API, immutable trees are less error-prone.
...
\begin{itemize}
    ...
    \item \textit{Work with the ASTs in a functional style, where every edit
        ...
        be disrupted, pointers to nodes in the original tree may be rendered 
